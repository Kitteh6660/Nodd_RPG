...
function appearanceScreen() {
	clearOutput();
	outputText("Your Ego Bracer projects an image depicting an exact mirror replica of you. You get a good look at yourself...<br><br>");
    var temp = 0;
    ...
    switch(player.faceType) {
        ...
        case FACE_DEER:
            ...
            break;
		case FACE_SERGAL:
			outputText(" Your face is like that of a sergal, with a wedge-shaped head.");
            if (player.skinType == SKIN_TYPE_PLAIN)
                outputText(" The " + player.skin() + " that is revealed by your lack of fur looks quite unusual.");
            else if (player.skinType == SKIN_TYPE_FUR)
                outputText(" It's covered in " + player.skinFurScales() + " that covers your " + player.skinTone + " skin underneath.");
    ...
    if (player.hairLength == 0) {
        ...
        //<mod>
            ...
            outputText(" A pair of fluffy sergal ears rise up from the top of your head that extend backwards.");
        //</mod>
    ...
    else if (player.armType == ARM_TYPE_SERGAL)
        outputText(" While your arms are fairly humanoid, a feature that sets your arms apart would be your four-fingered hands at the end of your arms, with pawpads covering your palms.");
    ...
    switch(player.tailType) {
        ...
        case TAIL_TYPE_DOG:
            ...
            break;
        case TAIL_TYPE_WOLF:
            outputText(" A fluffy " + player.furColor + " wolf tail sprouts just above your " + player.buttDescript() + ", wagging to and fro whenever you are happy.");
            break;
        ...
        case TAIL_TYPE_DEER:
            ...
            break;
        case TAIL_TYPE_SERGAL:
            outputText(" A long tail extends from just above your butt, resembling that of a sergal's. It becomes more fluffy near the end.");
            break;
        default:
            //No tail here!
    }
    ...
    else if (player.lowerBody == LOWER_BODY_TYPE_SERGAL)
        outputText(" " + Num2Text(player.legCount)+ " digitigrade legs form below your [hips], ending in sergal paws.");
    ...
    //MONEY!
    if (player.gloam == 0)
        outputText("<br><br><b>Your Ego Bracer does not contain any gloam stored. How sad.");
    if (player.gloam > 1)
        outputText("<br><br><b>You have " + formatNumber(Math.floor(player.gloam)) + " units of gloam stored in your Ego Bracer.");
    if (player.gloam == 1)
        outputText("<br><br><b>You have " + formatNumber(Math.floor(player.gloam)) + " unit of gloam stored in your Ego Bracer.");
	egoBracerMenu();
