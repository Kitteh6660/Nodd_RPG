...
function appearanceScreen() {
	...
	outputText(" <b>You are currently " + (player.armorDescript() != "gear" ? "wearing your " + player.armorDescript() : "naked") + " and using your " + (player.weapon != Items.NOTHING ? player.weapon.equipmentName : "fists") + " as a weapon.</b>");
    //HEAD DESCRIPTION
    //Face
