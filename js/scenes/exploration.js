...
Locations.GenericExploration = [];

Locations.GenericExploration.exploreMenu = function() {
    hideMenus();
    clearOutput();
    if (exploration.explored < 2) {
        Locations.GenericExploration.tryDiscover();
        return;
    }
    outputText("You can continue to search for new locations, or explore your previously discovered locations.");
    menu();
    addButton(0, "Explore", Locations.GenericExploration.tryDiscover);
    if (exploration.exploredForest > 0) addButton(1, "Forest", Locations.Forest.explore, null, null, null, "Visit the lush forest. <br><br>Recommended level: 1" + (player.level < 5 ? "<br><br>Beware of Tentacle Beasts!" : ""));
    if (exploration.exploredLake > 0) addButton(2, "Lake", Locations.Lake.explore, null, null, null, "Visit the lake and explore the beach. <br><br>Recommended level: 2");
    if (exploration.exploredDesert > 0) addButton(3, "Desert", Locations.Desert.explore, null, null, null, "Visit the dry desert. <br><br>Recommended level: 3");
    if (exploration.exploredMountain > 0) addButton(4, "Mountain", Locations.Mountain.explore, null, null, null, "Visit the mountain. <br><br>Recommended level: 5");
    addButton(14, "Back", Camp.doCamp);
}

Locations.GenericExploration.tryDiscover = function() {
    clearOutput();
    ...
    if (exploration.explored <= 0) {
        ...
        if (rand(100) > 0) {
            switch(rand(4)) {
                case 0:
                    Locations.GenericExploration.genericGobImpEncounters();
                    break;
                case 1:
...
Locations.GenericExploration.genericGobImpEncounters = function() {
